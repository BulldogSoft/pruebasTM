...
class LibroLine(models.Model):
    ...
    fecha_con = fields.Date(string=_('Fecha Contable'), )
    ...
    internas_e = fields.Monetary(
        ...
        currency_field='company_currency_id',
        readonly=True, help='Internas Exentas')
    importaciones_e = fields.Monetary(
        _('Importaciones'), store=True,
        currency_field='company_currency_id',
        readonly=True, help='Importaciones Exentas')
    internas_g = fields.Monetary(
        _('Internas'), store=True,
        currency_field='company_currency_id',
        readonly=True, help='Internas Gravadas')
    importaciones_g = fields.Monetary(
        _('Importaciones'), store=True,
        currency_field='company_currency_id',
        readonly=True, help='Importaciones Gravadas')
    ...
    internas_ns = fields.Monetary(
        _('Internas No Sujetas'), store=True,
        currency_field='company_currency_id',
        readonly=True, help='Internas No Sujetas')

    importacion_ns = fields.Monetary(
        _('importacion No Sujetas'), store=True,
        currency_field='company_currency_id',
        readonly=True, help='Importaciones No Sujetas')
