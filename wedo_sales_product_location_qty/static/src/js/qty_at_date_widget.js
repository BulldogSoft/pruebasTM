odoo.define('wedo_sale_product_location_qty.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidget = Widget.extend({
    template: 'wedo_sale_product_location_qty.qtyAtDate',
    ...
    _setPopOver: function () {
        ...
        var $content = $(QWeb.render('wedo_sale_product_location_qty.QtyDetailPopOver', {
            data: this.data,
        }));
...
widget_registry.add('sale_product_qty_at_date_widget', QtyAtDateWidget);
